...
ostream& operator<<(ostream& os, const Booking& b)//Implementation for the overloading of the operator <<, used by a Booking type object.
{
	os << "Client Name: " << b.clientName << "\nArrival Day: " <<b.arrivalDay << "\nAccomodation Days: " << b.accomodationDays << "\nPeopleNum: " << b.peopleNum << "\nBooking ID: " << b.bookingID << endl;//Printing a Booking *b information.
	return os;
}
